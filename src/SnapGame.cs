...
namespace CardGames
{
    public class SnapGame
    {
		...
		private static void DrawGame(Snap myGame)
		{
			...
			if (top != null)
			{
				SwinGame.DrawText ("Top Card is " + top.ToString (), Color.Orange, 0, 20);
				SwinGame.DrawText ("Player 1 score: " + myGame.Score(0), Color.Orange, 0, 30);
				SwinGame.DrawText ("Player 2 score: " + myGame.Score(1), Color.Orange, 0, 40);
				SwinGame.DrawCell (SwinGame.BitmapNamed ("Cards"), top.CardIndex, 350, 50);
			}
			else
			{
				SwinGame.DrawText ("No card played yet...", Color.Orange, 0, 20);
			}
